...
## Задание 3. Библиотека ParimatchList
Разработать собственную коллекцию ParimatchList.

### Введение
Библиотека “ParimatchList” содержит класс с собственной реализацией коллекции.

### Задание
Необходимо реализовать собственный ParimatchList<T>. Минимально требуемый интерфейс взаимодействия с экземпляром, должен включать метод добавления элемента, метод вставки элемента по индексу, метод удаления по индексу и удаления всех элементов, индексатор для получения значения элемента по указанному индексу и свойство только для чтения для получения количества элементов. ParimatchList<T> должен автоматически расширяться, если при добавлении нового элемента не хватает свободного места. Также нужно добавить возможность перебора элементов коллекции в цикле foreach.

**Для выполнения задания, необходимо предоставить собственную реализацию ParimatchList<T>:**
- Класс `ParimatchList` :
...
### Чек-лист
- Реализован все методы существующего класса `Hw3.Exercise3.ParimatchList`;
